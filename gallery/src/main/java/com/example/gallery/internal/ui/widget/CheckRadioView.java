...
public class CheckRadioView extends AppCompatImageView {
    ...
    private void init() {
        mSelectedColor = ResourcesCompat.getColor(getResources(), R.color.colorPrimary, getContext().getTheme());
        mUnSelectUdColor = ResourcesCompat.getColor(getResources(), R.color.check_original_radio_disable, getContext().getTheme());
        setChecked(false);
    }
