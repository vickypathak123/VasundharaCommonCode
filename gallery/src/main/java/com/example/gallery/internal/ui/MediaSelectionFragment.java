...
import com.example.gallery.internal.ui.widget.MediaGridInset;
import com.example.gallery.internal.utils.UIUtils;
...
public class MediaSelectionFragment extends Fragment implements AlbumMediaCollection.AlbumMediaCallbacks, AlbumMediaAdapter.CheckStateListener, AlbumMediaAdapter.OnMediaClickListener {
    ...
    public void onMediaClick(Album album, Item item, int adapterPosition, boolean isPreview) {
        if (mOnMediaClickListener != null) {
            mOnMediaClickListener.onMediaClick((Album) getArguments().getParcelable(EXTRA_ALBUM), item, adapterPosition, isPreview);
        }
    }
