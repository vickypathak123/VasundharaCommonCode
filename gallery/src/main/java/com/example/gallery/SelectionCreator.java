...
public final class SelectionCreator {
    private final AGallery mMatisse;
     ...
     */
    SelectionCreator(AGallery matisse, @NonNull Set<MimeType> mimeTypes, boolean mediaTypeExclusive) {
        mMatisse = matisse;
     ...
     *
     * @param minSelectable Minimum selectable count. Default value is 1.
     * @return {@link SelectionCreator} for fluent API.
     */
    public SelectionCreator minSelectable(int minSelectable) {
        mSelectionSpec.minSelectable = minSelectable;
        return this;
    }
    ...
    public SelectionCreator isNeedToShowAd(boolean enable) {
        mSelectionSpec.isNeedToShowAd = enable;
        return this;
    }
     ...
     * 1. {@link com.example.gallery.engine.impl.GlideEngine}
     * 2. {@link com.example.gallery.engine.impl.PicassoEngine}
     ...
     * <p>
     * It's a redundant API with {@link AGallery#obtainResult(Intent)},
    ...
    public SelectionCreator isNeedToShowGif(boolean enabled) {
        mSelectionSpec.isNeedToShowGif = enabled;
        return this;
    }
}
