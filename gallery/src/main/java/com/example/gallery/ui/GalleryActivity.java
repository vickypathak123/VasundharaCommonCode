...
import com.example.gallery.internal.ui.widget.AlbumsSpinner;
...
import com.example.gallery.internal.utils.PathUtils;
import com.example.gallery.internal.utils.PhotoMetadataUtils;
import com.example.gallery.internal.utils.SingleMediaScanner;
...
public class GalleryActivity extends AppCompatActivity implements
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PREVIEW) {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP)
                GalleryActivity.this.revokeUriPermission(contentUri,
    ...
    @Override
    public void onMediaClick(Album album, Item item, int adapterPosition, boolean isPreview) {
        if (mSpec.maxSelectable == 1 && !isPreview) {
            done();
        } else {
