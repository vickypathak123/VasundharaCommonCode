 ...
 */
public final class AGallery {

    private final WeakReference<Activity> mContext;
    private final WeakReference<Fragment> mFragment;

    private AGallery(Activity activity) {
        this(activity, null);
    }

    private AGallery(Fragment fragment) {
        this(fragment.getActivity(), fragment);
    }

    private AGallery(Activity activity, Fragment fragment) {
     ...
     */
    public static AGallery from(Activity activity) {
        return new AGallery(activity);
    }
     ...
     * @return Matisse instance.
     */
    public static AGallery from(Fragment fragment) {
        return new AGallery(fragment);
    }
