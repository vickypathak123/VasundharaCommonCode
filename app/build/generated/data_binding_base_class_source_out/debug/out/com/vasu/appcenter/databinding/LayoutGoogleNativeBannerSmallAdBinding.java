...
public final class LayoutGoogleNativeBannerSmallAdBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutGoogleNativeBannerSmallAdBinding(@NonNull NativeAdView rootView,
      @NonNull ImageView adAppIcon, @NonNull TextView adBody, @NonNull Button adCallToAction,
      @NonNull TextView adHeadline, @NonNull MediaView adMedia, @NonNull RatingBar adStars,
  ...
  @NonNull
  public static LayoutGoogleNativeBannerSmallAdBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutGoogleNativeBannerSmallAdBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_google_native_banner_small_ad, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutGoogleNativeBannerSmallAdBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutGoogleNativeBannerSmallAdBinding((NativeAdView) rootView, adAppIcon, adBody,
          adCallToAction, adHeadline, adMedia, adStars, txtAd);
    }
