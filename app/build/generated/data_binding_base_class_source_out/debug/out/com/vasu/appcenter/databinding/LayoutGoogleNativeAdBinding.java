...
public final class LayoutGoogleNativeAdBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutGoogleNativeAdBinding(@NonNull NativeAdView rootView,
  ...
  @NonNull
  public static LayoutGoogleNativeAdBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutGoogleNativeAdBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_google_native_ad, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutGoogleNativeAdBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutGoogleNativeAdBinding((NativeAdView) rootView, adAdvertiser, adAppIcon,
