...
private val TAG = "Admob_" + OfflineNativeAdvancedHelper::class.java.simpleName


object OfflineNativeAdvancedHelper {

    var unNativeAd: NativeAd? = null


    fun Context.loadOfflineNativeAdvance(fAdContainer: FrameLayout) {
        ...
        if (unNativeAd == null) {
            Log.e(TAG, "loadOfflineNativeAdvance: live ad")
            ...
            val adLoader = builder.withAdListener(object : AdListener() {
                ...
                override fun onAdClicked() {
                    ...
                    unNativeAd = null
                    loadOfflineNativeAdvance(fAdContainer)

                }
            }).build()
            adLoader.loadAd(AdRequest.Builder().build())
        } else {
            Log.e(TAG, "loadOfflineNativeAdvance: offline ad")
    ...
    public fun populateNativeAdView(nativeAd: NativeAd, adView: NativeAdView) {
        Log.i(TAG, Throwable().stackTrace[0].methodName)
